...
SECRET_KEY = '3%v8ox9wb%hc*o$uuo3e10zlr@$uq6b&uaf@)7%juz-lf&sc5+'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'myexam', # nombre de la base de datos, se creará en el servidor de Postgres a continuación
        'USER': 'postgres', # postgres para macOS o 'USER': 'postgres', para Windows
        'PASSWORD': '66204', # contraseña a la que la cambió al instalar Postgres
